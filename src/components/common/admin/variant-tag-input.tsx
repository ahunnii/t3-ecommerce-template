...
import type { tagVariants } from "~/components/ui/tag";
...
const VariantTagInput = React.forwardRef<HTMLInputElement, TagInputProps>(
  (props, ref) => {
    const {
      id,
      placeholder,
...
VariantTagInput.displayName = "VariantTagInput";

export { VariantTagInput };
