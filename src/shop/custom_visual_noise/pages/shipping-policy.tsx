          ...
          <div className="space-y-10 py-10 text-white">
            <div className="flex flex-col gap-y-8 px-4 sm:px-6 lg:px-8">
              <div className="space-y-4">
                ...
                <p>
                  Thank you for choosing [Your Company Name]! We are committed
                  to providing you with quality products and a delightful
                  shopping experience. Please take a moment to review our
                  shipping policy for information on how we handle the shipment
                  of your orders.
                </p>
                <h4 className="text-xl">Processing Time:</h4>
                <p>
                  All orders are typically processed within one week (7 days)
                  from the date of purchase. Our dedicated team ensures that
                  your items are crafted or prepared with care before being
                  dispatched.
                </p>
                <h4 className="text-xl">Shipping Fees:</h4>- Orders under $100:
                A flat shipping fee of $15 will be applied to all orders with a
                ...
                <p>
                  ...
                  secure and timely delivery of your items. The choice of
                  carrier may depend on your location and the nature of the
                  products ordered.
                </p>
                ...
                <p>
                  ...
                  shipping method. Please note that unforeseen circumstances
                  such as customs clearance or extreme weather conditions may
                ...
                <p>
                  ...
                  international customers and hope to expand our shipping
                ...
                <p>
                  ...
                  customer support team at [customer support email/phone
                  number].
                </p>
                <p>
