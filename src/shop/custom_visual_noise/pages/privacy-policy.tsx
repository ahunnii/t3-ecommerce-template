            ...
            <div className="flex flex-col gap-y-8 px-4 sm:px-6 lg:px-8">
              <div className="space-y-4">
                ...
                <p className="mb-4">
                  ...
                  use our services, including those who sign in through Auth0
                  for a streamlined and secure experience during the checkout
                  process.
                </p>
                ...
                <p className="mb-4">
                  ...
                  information to facilitate a secure and personalized
                  experience. This may include your name, email address, and any
                  other information provided during the authentication process.
                </p>
                ...
                <p className="mb-4">
                  ...
                  process and fulfill your orders, ensuring that your products
                  are delivered to the correct address in a timely manner.
                </p>
                ...
                <p className="mb-4">
                  b. Auth0 handles the authentication process securely, and we
                  do not store sensitive authentication data, such as passwords.
                </p>
                ...
                <p className="mb-4">
                  ...
                  your privacy or this policy, please contact our Data
                ...
                <p className="mt-6 text-gray-500">
                  Thank you for choosing [Your Company Name]! We value your
